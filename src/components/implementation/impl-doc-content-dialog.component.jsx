...
import { addImplTableContent, updateImplTableContent } from "services/implementation.service";
...
const ImplDocContentDialogComponent = ({ open, onClose, qaqtDocData, type, fetchData, editData }) => {
...
const handleDialogConfirm = async (formValues) => {
  ...
  if (isEditMode) {
    ...
    result = await updateImplTableContent(dto);
  } else {
    ...
    result = await addImplTableContent(dtoArray);
  }
...
export default ImplDocContentDialogComponent;
