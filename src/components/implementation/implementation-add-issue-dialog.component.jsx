...
import { addNewImplementationDocRelease, getImplDataAddedTemplates } from "services/implementation.service";

const ImplementationDocAddIssueDialog = ({ open, onClose, versionElements,projectId,onConfirm}) => {
    ...
    const setDataAddedTemplates = async () => {
        try {
            ...
            let list = await getImplDataAddedTemplates(projectId);
    ...
    const handleSubmit = async (values) => {
        ...
        if (confirm) {
            let response = await addNewImplementationDocRelease(addVerionDto);
    ...
    export default ImplementationDocAddIssueDialog;